...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Management
{
    public class WebFunctionsManager : IWebFunctionsManager
    {
        ...
        {
            return await ScriptHost.ReadFunctionsMetadata(_config, _logger, new Dictionary<string, Collection<string>>())
        ...
        {
            var functionMetadata = ScriptHost.ReadFunctionMetadata(Path.Combine(_config.RootScriptPath, name), _config, _logger, new Dictionary<string, Collection<string>>());
